...
#avgoutpath = "/root/MLBB-MyMLBB-Stats/timeline/averages"

#TEST
#outpath = "/var/www/html"
outpath = "/var/www/html/dev/summary-dev"
avgoutpath = "/var/www/html/dev/averages-dev"
              ...
              for m in mode:
                   for lvl in level:
                       ...
                       for hero in heroes:
                            ...
                            #set limit
                            #df2['kda'] = df2['kda'].mask(df2['kda'] > 20, 20.0)                            
                            df2 = df2[df2.kda < 20]
                            ...
                            for ax, column, color, (min_normal, max_normal) in zip(axs,
                                ...
                                df_abnormal.plot(x='runtime', xlabel="Date", y=column, ylabel=column,kind='scatter', marker='D',color='red', legend=False, zorder=3, ax=ax)
                            plt.style.use('dark_background')
                            ...
                            if (df2['kda']>20).any() or (df2['kda']<.05).any() or (df2['win']==100).any() or (df2['use']==0).any():
