...
outpath = "/var/www/html/timeline/summary"
csvpath = "/var/www/html/TierData/backfill"
avgoutpath = "/var/www/html/timeline/averages"
              ...
              for m in mode:
                   for lvl in level:
                       ...
                       for hero in heroes:
                            ...
                            if (df2['kda']>20).any() or (df2['win']==100).any() or (df2['use']==0).any():
