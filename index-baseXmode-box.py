...
reportout = "/var/www/html/reports/baseXmode-box"
csvout = "/var/www/html/reports/csv/baseXmode-box"
...
for l in lang:
    ...
    for r in region:
        for dt in dtrange:
            ...
            dfx.to_csv(f"{csvout}/{r}.csv",index=False)
            print(f"Combined CSV: {csvout}/{r}.csv")
            logging.info(f"Combined CSV: {csvout}/{r}.csv")
